...
var callData = JSON.parse(localStorage.getItem("skinData"));
if(callData == null)
{
    temp()
}
function temp()
{
    window.location.href="/nykaa/skin/data/skindata.html";
}
...
var path = document.createElement("div");
    //    <-------------------- change this------------------>
path.innerText="Home>Skin>Women, Men, Unisex>Cleansers";
var mensGrooming = document.createElement("div");
    //    <-------------------- change this------------------>
mensGrooming.innerText="Cleansers Products Collection";
// <----------------All Products start--------------->
...
sortHiddenDiv_discount_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
    //    <-------------------- change this------------------>
        var getDataForDiscount = JSON.parse(localStorage.getItem("skinData"));
        getDataForDiscount.map(function (element)
        {
            ...
            //    <-------------------- change this------------------>
            localStorage.setItem("skinData",JSON.stringify(arr))

        })
        //    <-------------------- change this------------------>
        window.location.href = "skinPage.html";
    }
})
...
sortHiddenDiv_name_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForName = JSON.parse(localStorage.getItem("skinData"));
...
sortHiddenDiv_rated_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForRating = JSON.parse(localStorage.getItem("skinData"));
...
sortHiddenDiv_high_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForHigh = JSON.parse(localStorage.getItem("skinData"));
...
sortHiddenDiv_low_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForLow = JSON.parse(localStorage.getItem("skinData"));
...
var callMenData = JSON.parse(localStorage.getItem("skinData"));
callMenData.map(function(element,index)
{
    ...
    var callQty = JSON.parse(localStorage.getItem("skinData"));

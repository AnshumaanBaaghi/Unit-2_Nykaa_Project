...
{
    window.location.href="/nykaa/makeup/makeUpPage.html"
})
...
data1.map(function (elem, index) {
    ...
    categoryimages.addEventListener("click", function(){
        window.location.href= "/makeup/makeUpPage.html";
    })
...
data9.map(function (elem, index) {
 ...
 var data10 = JSON.parse(localStorage.getItem("advicebarpicsData"));
 var advicebarpicsData = JSON.parse(localStorage.getItem("advicebarpicsData"))||[];

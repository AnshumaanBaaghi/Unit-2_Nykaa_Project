var callData = JSON.parse(localStorage.getItem("fragrance_perfume.html"));
if(callData == null)
{
    temp()
}
function temp()
{
    window.location.href="/unit2projectr/fragrance_perfume/fragrance_perfume/data/fragrance_perfume_data.html";
}
...
var path = document.createElement("div");
    //    <-------------------- change this------------------>
path.innerText="Home ❯ Brand  ❯ Stayfree";
var mensGrooming = document.createElement("div");
    //    <-------------------- change this------------------>
mensGrooming.innerText="Stayfree (19)";
// <----------------All Products start--------------->
...
sortHiddenDiv_popularity_check.addEventListener("change",function()
{
    ...
    {
        //    <-------------------- change this------------------>
        window.location.href="/fragrance/fragrance_perfume/data/fragrance_perfume_data.html"
    }
})
...
sortHiddenDiv_discount_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
    //    <-------------------- change this------------------>
        var getDataForDiscount = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
...
sortHiddenDiv_name_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForName = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
...
sortHiddenDiv_rated_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForRating = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
...
sortHiddenDiv_high_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForHigh = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
...
sortHiddenDiv_low_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForLow = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
...
var callMenData = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
callMenData.map(function(element,index)
{
    ...
    var callQty = JSON.parse(localStorage.getItem("fragrance_perfume_data"));

...
var callData = JSON.parse(localStorage.getItem("natural_data"));
if(callData == null)
{
    temp()
}
function temp()
{
    window.location.href="/unit2projectr/fragrance_perfume/fragrance_perfume/naturalData.html";
}
...
var path = document.createElement("div");
    //    <-------------------- change this------------------>
path.innerText="Home >  Brand > Mamaearth";
var mensGrooming = document.createElement("div");
    //    <-------------------- change this------------------>
mensGrooming.innerText="Mamaearth Products Online(317)";
// <----------------All Products start--------------->
...
sortHiddenDiv_discount_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
    //    <-------------------- change this------------------>
        var getDataForDiscount = JSON.parse(localStorage.getItem("natural_data"));
        getDataForDiscount.map(function (element)
        {
            ...
            //    <-------------------- change this------------------>
            localStorage.setItem("natural_data",JSON.stringify(arr))

        })
        //    <-------------------- change this------------------>
        window.location.href = "naturalpage.html";
    }
})
...
sortHiddenDiv_name_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForName = JSON.parse(localStorage.getItem("natural_data"));
...
sortHiddenDiv_rated_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForRating = JSON.parse(localStorage.getItem("natural_data"));
...
sortHiddenDiv_high_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForHigh = JSON.parse(localStorage.getItem("natural_data"));
...
sortHiddenDiv_low_check.addEventListener("change",function()
{
    if(this.checked)
    {
        var arr=[];
        //    <-------------------- change this------------------>
        var getDataForLow = JSON.parse(localStorage.getItem("natural_data"));
...
var callMenData = JSON.parse(localStorage.getItem("natural_data"));
callMenData.map(function(element,index)
{
    ...
    var callQty = JSON.parse(localStorage.getItem("natural_data"));

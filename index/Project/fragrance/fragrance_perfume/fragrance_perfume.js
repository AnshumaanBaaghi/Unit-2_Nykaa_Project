...
var callData = JSON.parse(localStorage.getItem("fragrance_perfume_data"));
if(callData == null)
{
    temp()
}
function temp()
{
    window.location.href="/Project/fragrance/fragrance_perfume/data/fragrance_perfume_data.html";
}
...
var path = document.createElement("div");
    //    <-------------------- change this------------------>
path.innerText="Home>Fragrance>Women, Men, Unisex>Perfumes (EDT / EDP)";
var mensGrooming = document.createElement("div");
    //    <-------------------- change this------------------>
mensGrooming.innerText="Perfumes (EDT / EDP) (2837)";
// <----------------All Products start--------------->
